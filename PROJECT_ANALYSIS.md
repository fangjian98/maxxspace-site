# TechNav Hub 项目完整解析文档

## 一、项目概述

**项目名称**: TechNav Hub (品牌名: Maxx Space)  
...
| 库 | 数量 | 用途 |
|---|------|------|
| **Radix UI** | 28+ | 无头组件 (shadcn/ui 风格) |
| **Lucide React** | 最新 | 图标系统 |
| **Framer Motion** | ^11.0.0 | 动画效果 |
| **Embla Carousel** | ^8.0.0 | 轮播组件 |
