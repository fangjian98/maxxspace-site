...
export default function Projects() {
  ...
  }, [searchQuery, data.projectCategories]);

  // Dynamic content from site settings
  const pageTitle = data.projectsPage?.title || "我的项目";
  const pageSubtitle = data.projectsPage?.subtitle || "精选的开源项目与实验性作品集合";
  const searchHint = data.projectsPage?.searchHint;
