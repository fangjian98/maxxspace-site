...
export default function Projects() {
  ...
  const filteredCategories = useMemo(() => {
    if (!searchQuery.trim()) return data.projectCategories;
  ...
  const pageTitle = data.projectsPage?.title || "开源项目";
  const pageSubtitle = data.projectsPage?.subtitle || "我的个人项目与实验作品";
